...
export const fetchMovies = createAsyncThunk('netfilx/trending', async ({ type }, thunkApi) => {
    const {
        netflix: {
            genres }
    } = thunkApi.getState();
...
export const fetchDataByGenre = createAsyncThunk('netfilx/moviesByGenres', async ({ genre, type }, thunkApi) => {
    const {
        netflix: {
            genres }
    } = thunkApi.getState();
